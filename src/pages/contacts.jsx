        ...
        <>
            ...
            <div class="flex">
                <div className="w-1/2 p-4">
                    ...
                    <h2 className="mb-5 text-4xl font-bold text-white">497 Evergreen Rd. Roseville, CA 95673</h2>
                ...
                <div className="w-1/2 p-8">
                    ...
                    <form className="mb-5 text-white" action="https://formsubmit.co/luxuryhotel@yopmail.com" method="POST">
                        <label class="input input-bordered flex items-center gap-2 input-success input-md w-full">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        ...
                        <br/>
                        <label>
                            <textarea type="text" name="Mensaje" placeholder="Escriba su mensaje" class="textarea textarea-success textarea-md w-full" required /><br/>
                        </label>
                        <br/>
